...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("BTCI");
    case mBTC: return QString("mBTCI");
    case uBTC: return QString::fromUtf8("μBTCI");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("Bitcoin Invest BTCIs"));
    case mBTC: return QString(QObject::tr("Milli-Bitcoin Invest BTCIs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-Bitcoin Invest BTCIs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
