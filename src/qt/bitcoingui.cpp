...
{
    resize(850, 550);
    setWindowTitle(tr("Bitcoin Invest BTCI") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Bitcoin Invest BTCI address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Bitcoin Invest BTCI"), this);
    aboutAction->setStatusTip(tr("Show information about Bitcoin Invest BTCI"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bitcoin Invest BTCI"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bitcoin Invest BTCI addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bitcoin Invest BTCI addresses"));
    secondAuthAction = new QAction(QIcon(":/icons/key"), tr("Second &auth..."), this);
    secondAuthAction->setStatusTip(tr("Second auth with your Bitcoin Invest BTCI addresses"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Bitcoin Invest BTCI client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Bitcoin Invest BTCI client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bitcoin Invest BTCI network", "", count));
}
...
{
    QString strTitle = tr("Bitcoin Invest BTCI") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Bitcoin Invest BTCI address or malformed URI parameters."));
    }
