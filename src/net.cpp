...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("Bitcoin Invest BTCI -ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("Bitcoin Invest BTCI-net");
...
static const char *strDNSSeed[][2] = {
	{"95.179.128.129", "95.179.128.129"},
	{"140.82.57.1", "140.82.57.1"},
	{"199.247.27.213", "199.247.27.213"}
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("Bitcoin Invest BTCI-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("Bitcoin Invest BTCI-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("Bitcoin Invest BTCI-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("Bitcoin Invest BTCI-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Bitcoin Invest BTCI is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("Bitcoin Invest BTCI-start");
